...
import chess.variant.Fluidity
import chess.format.FEN

class FluidityVariantTest extends ChessTest {

  "Fluidity chess" should {
    ...
    "Must explode surrounding non pawn pieces on capture" in {
      ...
      val maybeGame       = fenToGame(fenPosition, Fluidity)
    ...
    "In fluidity chess a king may walk into a square that is in the perimeter of the opponent king since it can't capture" in {
